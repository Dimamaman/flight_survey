...
import 'package:flight_survey/components/login/domain/login_state.dart';
...
void main() {
  group('LoginBloc — CONTEXT KERAK EMAS (oddiy unit test)', () {
    test('LoginEmailChanged — blocni to\'g\'ridan-to\'g\'ri yaratib event yuboramiz', () async {
  ...
  group('LoginBloc — CONTEXT KERAK (widget test, blocni context orqali olamiz)', () {
    testWidgets('Blocni context.read<LoginBloc>() orqali olamiz — context bor', (WidgetTester tester) async {
        ...
        MaterialApp(
          home: Scaffold(
            body: BlocProvider<LoginBloc>(
              create: (_) => LoginBloc(repository: repository, localization: localization),
              child: Builder(
                builder: (context) {
